...
const Navbar = ({ showMenu }: ShowMenuProp) => {
  return (
    <nav
      className={`flex flex-col md:flex-row gap-4 text-white md:text-amber-900 w-3/4 md:w-full md:max-w-[300px] lg:max-w-[360px] justify-center items-center md:justify-between font-poppins tracking-wider fixed top-0 transition-[left] duration-300 ${
