...
const Button = ({ text, clickFunc }: ButtonProp) => {
  return (
    <button
      onClick={clickFunc}
      className='relative group cursor-pointer text-sky-50  overflow-hidden rounded-md bg-accent-one py-3 px-6 flex justify-center items-center font-extrabold self-center md:self-start button-shadow'>
